...
@Log4j
public class EditorPermissionsTest extends BaseTest {

    {
        log.info("Load from properties file EDITOR_LOGIN " + ConfigProperties.prop.getProperty("EDITOR_LOGIN") +
                " and EDITOR_PASSWORD");
    }
    private LoginData loginData = new LoginData(ConfigProperties.prop.getProperty("EDITOR_LOGIN"),
            ConfigProperties.prop.getProperty("EDITOR_PASSWORD"));

    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Pages tests")
    @Issue(value = "BugId-301") @TmsLink(value = "TestId-401")
    @Test(priority=1)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Pages tests")
    @Issue(value = "BugId-302") @TmsLink(value = "TestId-402")
    @Test(priority=2)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Pages tests")
    @Issue(value = "BugId-303") @TmsLink(value = "TestId-403")
    @Test(priority=3)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Pages tests")
    @Issue(value = "BugId-304") @TmsLink(value = "TestId-404")
    @Test(priority=4)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Pages tests")
    @Issue(value = "BugId-305") @TmsLink(value = "TestId-405")
    @Test(priority=5)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Pages tests")
    @Issue(value = "BugId-306") @TmsLink(value = "TestId-406")
    @Test(priority=6)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Posts tests")
    @Issue(value = "BugId-307") @TmsLink(value = "TestId-407")
    @Test(priority=7)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Posts tests")
    @Issue(value = "BugId-308") @TmsLink(value = "TestId-408")
    @Test(priority=8)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Posts tests")
    @Issue(value = "BugId-309") @TmsLink(value = "TestId-409")
    @Test(priority=9)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Posts tests")
    @Issue(value = "BugId-310") @TmsLink(value = "TestId-410")
    @Test(priority=10)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Posts tests")
    @Issue(value = "BugId-311") @TmsLink(value = "TestId-411")
    @Test(priority=11)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Posts tests")
    @Issue(value = "BugId-312") @TmsLink(value = "TestId-412")
    @Test(priority=12)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Comments tests")
    @Issue(value = "BugId-313") @TmsLink(value = "TestId-413")
    @Test(priority=13)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Comments tests")
    @Issue(value = "BugId-314") @TmsLink(value = "TestId-414")
    @Test(priority=14)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Comments tests")
    @Issue(value = "BugId-315") @TmsLink(value = "TestId-415")
    @Test(priority=15)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Comments tests")
    @Issue(value = "BugId-316") @TmsLink(value = "TestId-416")
    @Test(priority=16)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Media tests")
    @Issue(value = "BugId-317") @TmsLink(value = "TestId-417")
    @Test(priority=17)
    ...
    @Epic(value = "Final project testing") @Feature(value = "Editor permissions tests") @Story(value = "Media tests")
    @Issue(value = "BugId-318") @TmsLink(value = "TestId-418")
    @Test(priority=18)
